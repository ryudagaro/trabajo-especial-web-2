...
-- Last modification date: 2026-04-27 15:17:29.953

-- tables
-- Table: PARTICIPANTE
CREATE TABLE PARTICIPANTE (
    id_elenco int  NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE PELICULA (
    id_pelicula int  NOT NULL GENERATED ALWAYS AS IDENTITY,
